      ...
      <Card.Body>
        ...
        <Form>
          ...
          <div class="form-group">
           ...
           <Button type="submit" class="btn btn-primary" disabled={buttonDisabled} onClick={r =>{handle(); clearForm();window.alert("Account created. Click ok to create another account")}}>Create Account</Button> 
        </Form>
